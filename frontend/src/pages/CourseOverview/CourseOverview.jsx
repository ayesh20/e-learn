...
const CourseOverview = () => {
  const [activeTab, setActiveTab] = useState('overview'); // State for switching between Overview and Curriculum
        ...
        <div className={styles.leftColumn}>
          ...
          {activeTab === 'overview' && (
            <div className={styles.overviewContent}>
              ...
              {/* You can add more overview content here */}
            </div>
          )}
              ...
              {curriculumData.map(section => (
                <div key={section.id} className={styles.curriculumSection}>
                  <div className={styles.sectionHeader}>
                    <i className="fas fa-chevron-right"></i> {/* Collapsible icon */}
                    <h4>{section.title}</h4>
                  ...
                  <div className={styles.subLessons}>
                    {section.subLessons.map(lesson => (
                      <div key={lesson.id} className={styles.subLessonItem}>
                        <i className="fas fa-file-video"></i> {/* Video icon */}
